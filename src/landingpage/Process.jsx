...
const Process = ({ scrollToIncluded }) => {
  ...
  return (
    <div className="flex flex-wrap w-full px-8 md:px-16 mt-20 relative">
      ...
      <div ref={processRef}
        onScroll={handleScroll} className="w-full z-20 py-2 mt-24 md:mt-0 flex flex-col process items-end h-full md:h-[36rem] md:overflow-y-scroll">
        <div className="flex flex-col items-end h-fit w-full md:w-[623px]">
          <div className="w-full  md:h-[3595px] flex">
            <div className="flex flex-col process-comp bg-contain bg-no-repeat md:h-full w-[305px]  md:w-[32.125rem] h-full gap-6 py-12">
        ...
        <div className="w-full flex">
          <div className="hidden md:flex gap-3.5 items-center z-50 translate-x-3">
