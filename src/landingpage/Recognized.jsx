      ...
      <div className="bg-white rounded-2xl w-full max-w-5xl flex flex-col items-center py-8 overflow-hidden">
        ...
        <div className="w-full overflow-hidden">
          <div className="flex justify-around md:justify-around">
            <img src={recog1} className="h-20 md:h-28 lg:h-36 md:mx-12" alt="Startup India logo" />
            <img src={recog2} className="h-20 md:h-28 lg:h-36 md:mx-12" alt="Startup Mission logo" />
          </div>
        </div>
      </div>
    </div>
