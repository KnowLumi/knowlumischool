  ...
  return (
    <div className="flex flex-col items-center ">
      ...
      <div className="w-full h-full flex justify-center font-archivo">
        <div className="enroll-banner w-80 md:w-[71rem]  md:mx-12 bg-contain h-[36rem] md:h-[40rem] bg-no-repeat flex flex-col justify-between p-8">
          ...
          <div className="bg-[url('src/assets/enroll1_mobile.png')] md:bg-[url('src/assets/enroll1.png')] bg-contain bg-no-repeat h-40 flex justify-between items-center">
