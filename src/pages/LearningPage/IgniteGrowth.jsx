...
const IgniteGrowth = ({course}) => {
  //onEroll Click Send A custom Whatsapp message to the admin phone
  const onEnrollClick = () => {
    window.open(
    ...
    <div className="rounded-3xl bg-[#DFDFD7] flex flex-wrap items-center gap-6 justify-between md:py-9 py-4 pl-4 pr-2 md:px-12 mx-6 md:mx-20">
      <div className="flex flex-col gap-6">
        ...
        <p className="font-light text-sm tracking-wider md:w-[33.75rem]">
          Whether you&apos;re a beginner or an intermediate professional seeking
          to upskill, transition, or broaden your horizons in the field, our
      ...
      <div className="flex flex-col w-fit md:flex-row gap-6 md:gap-11 items-center">
        <Link to="/fundamentals">
          <Button
            className="rounded-full flex items-center gap-3 capitalize font-archivo text-sm tracking-widest font-medium text-[16px] bg-black text-white py-2 pr-2 pl-6"
