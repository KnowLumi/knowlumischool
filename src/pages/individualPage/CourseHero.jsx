      ...
      <div className="w-full h-full flex justify-center font-archivo">
        <div  className="enroll-banner w-80 md:w-[71rem] mx-0 md:mx-12 bg-contain h-[36rem] md:h-[40rem] bg-no-repeat flex flex-col justify-between p-4 md:p-8">
          <div className="flex flex-col mt-12 gap-5">
            ...
            <span className="md:w-[38.1rem] font-normal w-[18rem] text-5xl md:text-[4.5rem] leading-[4.9rem] text-white text-wrap">
              {course.title}
            </span>
          </div>
          <div className="enroll1 bg-cover md:bg-contain bg-no-repeat rounded-3xl md:h-40  flex justify-between items-center">
            <div className="flex flex-col justify-between gap-4 mt-2 mx-1.5 md:mx-4">
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col w-56 md:w-96 text-wrap">
                  <span className="font-semibold text-xs md:text-sm uppercase drop-shadow-2xl">
                    {course.title}
                  </span>
                  <p className="font-light text-[10px] md:text-sm md:pb-1">
                    {course.description}
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <Button
                  variant="outlined"
                  className="my-button -translate-y-2 capitalize font-archivo text-black py-[3px] pr-[3px] pl-[18px] border-gray-300 flex w-fit justify-end gap-3 items-center rounded-full"
                >
